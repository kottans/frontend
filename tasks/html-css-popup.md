...
- очікується, що спливаюче вікно (popup) матиме три стани залежно від дій користувача:
  - початковий стан: спливаюче меню не видно
  - після натискання на кнопку ![popup-button](../img/popup-button.png)
    спливаюче меню стає видимим або прихованим, якщо воно вже відкрите
...
Початковий стан: спливаюче вікно не видиме:
