...
# У мене є питання по завданням!
Пропонуємо ознайомитись з нашим гайдом [Як задавати питання](HTAQ.md).
Ці правила допоможуть вам отримати відповідь швидше, а менторам та іншим студентам відповідати легше.
