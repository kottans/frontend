...
змінити свій запис пізніше, якщо захочете доробити необов'язкові вправи.

_Переконайтеся, що файл містить порожній рядок у кінці файлу._
_Якщо ви редактуєте файл через інтерфейс GitHub, додайте 2 порожніх рядки у кінці._

Опис полей:

- **Дата** це дата, в яку ви виконали обов'язкові вправи (дата останнього коміту
